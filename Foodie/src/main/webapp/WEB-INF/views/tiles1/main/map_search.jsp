    ...
    <script>
            ...
            for (var i = 0; i < places.length; i++) {
                ...
                (function(marker, title) {
                    ...
                    itemEl.onclick = function() {
                        skmpla = $(this).text();
                        subpla = skmpla.substring(0, 12);
                        srid = subpla.replace(/[^0-9]/g, "");
                        console.log(srid + ', ' + srid.length + ', ' + typeof(srid));
                        placeFormal(srid);
                    };
        ...
        function getListItem(index, places) {
            ...
            var el = document.createElement('li'),
                ...
                '<div class="info">' +
                '   <span class="storeidlaa">' + rid + '</span> <h5>' + places.place_name + '</h5>';

            console.log(index + ', ' + rid + ', ' + rid.length + ', ' + typeof(rid));

            $('span.storeidl').click(function() {
                alert("li stordidl click")
            });
        ...
        function placeFormal(placeId) {
            $("input.kakao_store_id").val(placeId);
