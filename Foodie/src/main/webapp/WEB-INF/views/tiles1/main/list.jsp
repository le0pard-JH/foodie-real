...
<!-- css Styles -->
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/bootstrap.min.css" type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/font-awesome.min.css" type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/ss/elegant-icons.css" type="text/css">
<link rel="stylesheet" href="<%=ctxPath%>/resources/css/flaticon.css"
	type="text/css">
<link rel="stylesheet" href="<%=ctxPath%>/resources/css/nice-select.css"
	type="text/css">
<link rel="stylesheet" href="<%=ctxPath%>/resources/css/barfiller.css"
	type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/magnific-popup.css" type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/jquery-ui.min.css" type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/owl.carousel.min.css" type="text/css">
<link rel="stylesheet"
	href="<%=ctxPath%>/resources/css/slicknav.min.css" type="text/css">
...
<body>
	...
	<div id="mycontent">
							...
							<div class="listing__item__text__inside">
								...
								<ul>
									<li><span class="icon_pin_alt"></span>
										우편번호-${searchList.postcode} <br> ${searchList.address}</li>
									<li><span class="icon_phone"></span> ${searchList.call}</li>
								</ul>
							</div>
							<div class="listing__item__text__info">
								<div class="listing__item__text__info__left">
									<img
										src="<%=ctxPath%>/resources/img/listing/list_small_icon-1.png">
					...
					<div class="option">
						<div>
							<form onsubmit="searchPlaces(); return false;">
								키워드 : <input type="text" value="${param.searchWord}"
									id="keyword" size="15">
		...
		<script type="text/javascript"
			src="https://dapi.kakao.com/v2/maps/sdk.js?appkey=8a283a84534cab3af87f95bcee93c9a4&libraries=services"></script>
		<script>
			...
			function displayPlaces(places) {
				var listEl = document.getElementById('placesList'), menuEl = document
						...
						.createDocumentFragment(), bounds = new kakao.maps.LatLngBounds(), skmpla = '', subpla = '', sridpla = '', ikplapls = '', regSkplaid = '', listStr = '';
				...
				for (var i = 0; i < places.length; i++) {
					...
					(function(marker, title) {
						...
						itemEl.onclick = function() {
							...
							console.log(regSkplaid + ', ' + regSkplaid.length
									+ ', ' + typeof (regSkplaid));
			...
			function getListItem(index, places) {
				...
				var el = document.createElement('li'), itemStr = '<span class="markerbg marker_'
						...
						+ '"></span>'
						+ '<div class="info">'
						+ ' <input type="hidden" value="' + rid + '" class="ikplapltxt" />'
						+ '   <span id="storeidlaa" class="spandata" style="display:none;" >'
						+ rid
						+ '</span> '
						+ '<h5>'
						+ places.place_name
						+ '</h5>';
				console.log(index + ', ' + rid + ', ' + rid.length + ', '
						+ typeof (rid));
			...
			function placeFormal(cliregSkplaid) {
				console.log('placeFormal : ' + cliregSkplaid + ', '
						+ cliregSkplaid.length + ', ' + typeof (cliregSkplaid));
